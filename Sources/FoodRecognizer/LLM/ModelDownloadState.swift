...
@MainActor
public final class ModelDownloadState: ObservableObject {

    public static let shared = ModelDownloadState()
    ...
    @Published public var phase: ModelDownloadPhase = .initialDownload
